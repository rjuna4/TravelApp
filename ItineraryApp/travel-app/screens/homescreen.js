     ...
     {/*<Text style={styles.text}>Trending Destinations</Text>*/}
       ...
       <View style={styles.activityMenu}>
         <ActivityMenu
           key={"restaurants"}
           name="Restaurants"
           image={require('travel-app/assets/icons/restaurant(2).png')}
         ...
         <ActivityMenu
           key={"attractions"}
           name="Attractions"
           image={require('travel-app/assets/icons/beach.png')}
           activityType={activityType}
           changeActivityType={changeActivityType}
         />
         <ActivityMenu
           key={"hotels"}
           name="Hotels"
           image={require('travel-app/assets/icons/hotel(2).png')}
           activityType={activityType}
           changeActivityType={changeActivityType}
         />
       </View>
